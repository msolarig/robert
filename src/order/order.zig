...
const Order = struct {
    ...
    pub fn init(instrument: []const u8, order_type: OrderType, direction: OrderDirection, price: f64, volume: u64, time_in_force: OrderTimeInForce, time_condition: OrderTimeCondition) Order {
        return Order{
